...
from cart_pole_model_augmented import cart_pole_model_augmented
# ------------------------------------------------------------
...
# ============ MODELO ============
model = cart_pole_model_augmented()
nx = model.x.size1()      # 4
nu = model.u.size1()      # 1
...
ocp.solver_options.ext_fun_compile_flags = '-O0 -fPIC'
ocp.solver_options.compile_interface = 'STATIC'

# ============ CREACIÓN DEL SOLVER ============
try:
    ocp_solver = AcadosOcpSolver(ocp, json_file='cart_pole_ocp_augmented.json')
