function [cdg, I_total] = new_cdg_and_inertia(m_hat, pos_lift, d_hat)
...
m   = [16; 5; 5; 2; m_hat];                 
x   = [0.0; -0.15; -0.1; 0.3; -0.1 + d_hat];          
z   = [0.5;  1.2+pos_lift; 1.05+pos_lift; 1.05+pos_lift; 1.05+pos_lift];         
I_y = [1.4533; 0.9417; 0.1531; 0.03; 0]; 
